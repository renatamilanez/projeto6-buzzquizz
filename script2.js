...
function validarPerguntasQuizz() {
  ...
  if (
    ...
    resposta1.value !== "" &&
    resposta2.value !== "" &&
    ((url1.value !== "" && urlQuizz1.includes("https")) ||
...
function salvarPerguntasArray() {
  for (let i = 1; i <= qtdadeQuizz.value; i++) {
    let resposta1 = document.getElementsByClassName(
      `resposta-pergunta-1 ${[i]}`
    )[0];
    let url1 = document.getElementsByClassName(`url-pergunta-1 ${[i]}`)[0];
    let resposta2 = document.getElementsByClassName(
      `resposta-pergunta-2 ${[i]}`
    )[0];
    let url2 = document.getElementsByClassName(`url-pergunta-2 ${[i]}`)[0];
    let resposta3 = document.getElementsByClassName(
      `resposta-pergunta-3 ${[i]}`
    )[0];
    let url3 = document.getElementsByClassName(`url-pergunta-3 ${[i]}`)[0];
    let resposta4 = document.getElementsByClassName(
      `resposta-pergunta-4 ${[i]}`
    )[0];
